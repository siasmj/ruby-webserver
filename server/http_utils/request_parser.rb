...
class RequestParser
  # Maximum URI length per the HTTP standard
  MAX_URI_LENGTH = 2083
  # How the maximum header length is defined in Puma
  ...
  class << self
    ...
    def read_headers(conn)
      ...
      loop do
        ...
        # Header name and value are separated by a colon and space
        key, value = line.split(/:\s/, 2)
        # Rack expects all headers to be prefixed with HTTP_ and upper cased
        headers[key] = value
      end
      headers
    end
